 ...
 */
class PrintableViewSubscriber implements EventSubscriberInterface {
  ...
  /**
   * Constructs a new PrintableViewSubscriber object.
   *
  ...
  public function onViewRenderArray(GetResponseForControllerResultEvent $event) {
    ...
    if ($request->getRequestFormat() == 'drupal_printable') {
      $renderer = $this->classResolver->getInstanceFromDefinition($this->mainContentRenderers['drupal_printable']);
